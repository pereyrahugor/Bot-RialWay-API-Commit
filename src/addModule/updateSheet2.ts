...
const SHEET_ID = process.env.SHEET_ID_UPDATE_2 ?? "";
const SHEET_NAME_RAW = process.env.SHEET_NAME_UPDATE_2 ?? "";
...
if (!SHEET_ID || !SHEET_NAME) {
    throw new Error("❌ Las variables de entorno SHEET_ID_UPDATE_2 y SHEET_NAME_UPDATE_2 deben estar definidas.");
}
...
export async function updateSheet2() {
    try {
